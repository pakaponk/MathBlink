...
<!--<div style="padding: 0px;margin-left: 50px;margin-right: 50px;width: 350px">
    ...
    <div style="padding: 10px;margin-left: 50px;width: 350px">
        ...
        <div style="margin-top: 5px;text-align: center">
            <a href="<?php echo $this->Html->Url(array('controller'=>'teacher','action'=>'full_calendar_lesson_plan',$data["Course"]["course_id"])) ; ?>" class="btn btn-primary">View Full Screen Calendar</a></div>
    </div>
...
<span style="float: right;width: 230px;margin-top: 10px"><a href="<?php echo $this->Html->Url(array('controller'=>'teacher','action'=>'full_lesson_plan',$data["Course"]["course_id"]))?>" class="btn btn-primary">View Full Lesson Plan</a></span>
